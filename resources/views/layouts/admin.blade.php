...
<head>
    ...
    <title>Sistema Automotriz</title>
    ...
    <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/inventario/create') }}" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Agregar vehiculo</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/inventario') }}" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Listar vehiculo</p>
                                    </a>
                                </li>
                        ...
                        <!--para usuarios en linea-->
                        <li class="nav-item">
                            <a href="#" class="nav-link active bg-prymary">
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
                Grupo de seguridad de sistemas
            </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024-2025 <a href="https://youtu.be/BtLSaxRnIhc">Seguridad de sistemas</a></strong> Todos los derechos reservados
        </footer>
    </div>
    <!-- ./wrapper -->
